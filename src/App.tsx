...
function AppContent() {
  const { loading, error, metrics, derivedSorted, addTask, updateTask, deleteTask, undoDelete, lastDeleted, resetLastDeleted } = useTasksContext();
  ...
  const handleDelete = useCallback((id: string) => {
    console.log('[App] handleDelete called, id:', id);
    deleteTask(id);
    ...
    <Box sx={{ minHeight: '100dvh', bgcolor: 'background.default' }}>
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 5 } }}>
        <Stack spacing={3}>
          ...
          {/* Debug: */ /* console.log('[App] Render UndoSnackbar, lastDeleted:', lastDeleted) */}
        </Stack>
